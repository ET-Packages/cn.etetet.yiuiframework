...
namespace YIUIFramework
{
    ...
    {
        public static readonly ObjectPool<UITaskEventHandleP0> HandlerPool = new ObjectPool<UITaskEventHandleP0>(null, handler => handler.Dispose());
    }
    ...
    public sealed class UITaskEventHandleP0
    {
        ...
        internal UITaskEventHandleP0 Init(LinkedList<UITaskEventHandleP0>     uiTaskList,
