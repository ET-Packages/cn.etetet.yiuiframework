...
namespace YIUIFramework
{
    ...
    public partial class UITaskEventBindClickString : UITaskEventBindClick
    {
        [SerializeField]
        ...
        [NonSerialized]
        private readonly List<EUIEventParamType> m_FilterParamType = new() { EUIEventParamType.String };
