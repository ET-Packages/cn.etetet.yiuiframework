...
namespace YIUIFramework
{
    ...
    [AddComponentMenu("YIUIBind/Event/点击 【Click PointerEventData】 UIEventBindClickPointerEventData")]
    public partial class UIEventBindClickPointerEventData : UIEventBindClick
    {
        [NonSerialized]
