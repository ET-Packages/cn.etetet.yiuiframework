...
namespace YIUIFramework
{
    ...
    [LabelText("输入栏<string> 结束时 异步")]
    [RequireComponent(typeof(TMP_InputField))]
    [AddComponentMenu("YIUIBind/TaskEvent/输入栏 【InputFieldEnd TMP】 UITaskEventBindInputFieldEndTMP")]
    public partial class UITaskEventBindInputFieldEndTMP : UIEventBind
    {
        [SerializeField]
        [ReadOnly]
        [Required("必须有此组件")]
        ...
        private async ETTask OnTaskEvent(string value)
        {
            await m_UIEvent?.InvokeAsync(value);
        }
    }
}
#endif
