...
namespace YIUIFramework
{
    ...
    public class UIEventBindKeepPress : UIEventBind, IPointerDownHandler, IPointerMoveHandler, IPointerUpHandler, IPointerExitHandler
    {
        ...
        public void OnPointerDown(PointerEventData eventData)
        {
            ...
            ET.EventSystem.Instance?.YIUIInvokeEntitySync(Entity, new YIUIInvokeEntity_CountDownAdd { TimerCallback = PressEnd, TotalTime = 0, Interval = m_PressTime });
        }
        ...
        private void RemoveCountDown()
        {
            if (m_PointerDown)
            {
                ET.EventSystem.Instance?.YIUIInvokeEntitySync(Entity, new YIUIInvokeEntity_CountDownRemove { TimerCallback = PressEnd });
            }
