...
namespace ET
{
    ...
    public partial class Entity
    {
        ...
        public T AddYIUIChild<T, A, B>(A a, B b, bool isFromPool = false) where T : Entity, IAwake<A, B>
        {
            Type type      = typeof(T);
        ...
        public K GetComponent<K>(bool log) where K : Entity
        {
            ...
            if (!this.components.TryGetValue(GetLongHashCodeByType(typeof(K)), out Entity component))
            {
