...
namespace ET.Client
{
    public static partial class YIUIRootComponentSystem
    {
        ...
        {
            return await YIUIMgrComponent.Inst.OpenPanelWaitAsync<T>(self);
        }
        ...
        {
            return await YIUIMgrComponent.Inst.OpenPanelWaitParamAsync<T>(self, paramMore);
        }
        ...
        {
            return await YIUIMgrComponent.Inst.OpenPanelWaitAsync<T, P1>(self, p1);
        }
        ...
        {
            return await YIUIMgrComponent.Inst.OpenPanelWaitAsync<T, P1, P2>(self, p1, p2);
        }
        ...
        {
            return await YIUIMgrComponent.Inst.OpenPanelWaitAsync<T, P1, P2, P3>(self, p1, p2, p3);
        }
        ...
        {
            return await YIUIMgrComponent.Inst.OpenPanelWaitAsync<T, P1, P2, P3, P4>(self, p1, p2, p3, p4);
        }
        ...
        {
            return await YIUIMgrComponent.Inst.OpenPanelWaitAsync<T, P1, P2, P3, P4, P5>(self, p1, p2, p3, p4, p5);
        }
    }
}
