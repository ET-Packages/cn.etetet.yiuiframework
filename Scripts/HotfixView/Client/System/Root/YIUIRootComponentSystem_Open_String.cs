namespace ET.Client
{
    public static partial class YIUIRootComponentSystem
    {
        ...
        public static async ETTask<Entity> OpenPanelAsync<P1>(this YIUIRootComponent self, string componentName, P1 p1)
        {
            return await YIUIMgrComponent.Inst.OpenPanelAsync(componentName, self, p1);
        }

        public static async ETTask<Entity> OpenPanelAsync<P1, P2>(this YIUIRootComponent self, string componentName, P1 p1, P2 p2)
        {
            return await YIUIMgrComponent.Inst.OpenPanelAsync(componentName, self, p1, p2);
        }

        public static async ETTask<Entity> OpenPanelAsync<P1, P2, P3>(this YIUIRootComponent self, string componentName, P1 p1, P2 p2, P3 p3)
        {
