...
namespace ET.Client
{
    ...
    {
        private static async ETTask<HashWaitError> PanelWait(Entity panel, long timeout = 0)
        {
        ...
        internal static async ETTask<HashWaitError> OpenPanelWaitAsync<T>(this YIUIMgrComponent self, Entity root, long timeout = 0)
        ...
        internal static async ETTask<HashWaitError> OpenPanelWaitParamAsync<T>(this YIUIMgrComponent self, Entity root, long timeout = 0, params object[] paramMore)
        ...
        internal static async ETTask<HashWaitError> OpenPanelWaitAsync<T, P1>(this YIUIMgrComponent self, Entity root, P1 p1, long timeout = 0)
        ...
        internal static async ETTask<HashWaitError> OpenPanelWaitAsync<T, P1, P2>(this YIUIMgrComponent self, Entity root, P1 p1, P2 p2, long timeout = 0)
        ...
        internal static async ETTask<HashWaitError> OpenPanelWaitAsync<T, P1, P2, P3>(this YIUIMgrComponent self, Entity root, P1 p1, P2 p2, P3 p3, long timeout = 0)
        ...
        internal static async ETTask<HashWaitError> OpenPanelWaitAsync<T, P1, P2, P3, P4>(this YIUIMgrComponent self, Entity root, P1 p1, P2 p2, P3 p3, P4 p4, long timeout = 0)
        ...
        internal static async ETTask<HashWaitError> OpenPanelWaitAsync<T, P1, P2, P3, P4, P5>(this YIUIMgrComponent self, Entity root, P1 p1, P2 p2, P3 p3, P4 p4, P5 p5, long timeout = 0)
